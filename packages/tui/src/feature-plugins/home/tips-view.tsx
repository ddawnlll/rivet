...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Rivet from reading sensitive files",
  "Use {highlight}rivet run{/highlight} for non-interactive scripting",
  "Use {highlight}rivet --continue{/highlight} to resume the last session",
  "Use {highlight}rivet run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}rivet serve{/highlight} for headless API access to Rivet",
  "Use {highlight}rivet run --attach{/highlight} to connect to a running server",
  "Run {highlight}rivet upgrade{/highlight} to update to the latest version",
  "Run {highlight}rivet auth list{/highlight} to see all configured providers",
  "Run {highlight}rivet agent create{/highlight} for guided agent creation",
  "Use {highlight}/rivet{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}rivet github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/rivet fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}rivet debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with Rivet Zen for curated, tested models",
