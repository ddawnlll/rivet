...
export const Definitions = {
  ...
  rivet_state: keybind("<leader>S", "Open State view"),
  rivet_code: keybind("<leader>C", "Open Code context view"),
  rivet_changes: keybind("<leader>D", "Open Changes view"),
  rivet_verify: keybind("<leader>V", "Open Verify view"),
  rivet_memory: keybind("<leader>M", "Open Memory view"),
  rivet_history: keybind("<leader>H", "Open History view"),
...
export const CommandMap = {
  ...
  rivet_state: "rivet.state",
  rivet_code: "rivet.code",
  rivet_changes: "rivet.changes",
  rivet_verify: "rivet.verify",
  rivet_memory: "rivet.memory",
  rivet_history: "rivet.history",
